...
csvfile = "/home/pi/Desktop/IMUdata_Outputs/IMUdata_" + str(time.gmtime()) + ".csv"
...
#using the variables defined above, the values print in the csv file

	row = [xrotation, yrotation, gyrox, gyroy, gyroz]
	writer.writerow(row)
